...
public class BurgerButtonFunctionalityPage extends BasePage{
    ...
    public void clickOnFirstItemInTheBurgerButtonMenu(){driver.findElement(firstItemInTheBurgerButtonMenu).click();}

    By secondItemInTheBurgerButtonMenu = By.id("about_sidebar_link");
    public void clickOnSecondItemInTheBurgerButtonMenu(){driver.findElement(secondItemInTheBurgerButtonMenu).click();}

    By thirdItemInTheBurgerButtonMenu = By.id("logout_sidebar_link");
    public void clickOnThirdItemInTheBurgerButtonMenu(){driver.findElement(thirdItemInTheBurgerButtonMenu).click();}

    By fourthItemInTheBurgerButtonMenu = By.id("reset_sidebar_link");
    public void clickOnFourthItemInTheBurgerButtonMenu(){driver.findElement(fourthItemInTheBurgerButtonMenu).click();}
