...
public class PurchasingFunctionalityPage extends BasePage{
    ...
    public void clickOnContinue(){driver.findElement(continuue).click();}

    By firstNameBox = By.id("first-name");
    public void insertFirstName(){driver.findElement(firstNameBox).sendKeys("UserFirstNme");}

    By lastNme = By.id("last-name");
    public void insertLastNme(){driver.findElement(lastNme).sendKeys("UserLastName");}

    By postalCode = By.id("postal-code");
    public void insertPostalCode(){driver.findElement(postalCode).sendKeys("121212");}

    By finish = By.id("finish");
    public void clickOnFinishButton(){driver.findElement(finish).click();}
