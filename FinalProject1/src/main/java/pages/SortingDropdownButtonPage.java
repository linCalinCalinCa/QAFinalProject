...
public class SortingDropdownButtonPage extends BasePage {
    ...
    public void clickOnTheFirstItemInDropdownListButton() {
        driver.findElement(firstItemInDropdownListButton).click();
    }

    By secondItemInDropdownListButton = By.xpath("/html/body/div/div/div/div[1]/div[2]/div/span/select/option[2]");
    public void clickOnTheSecondItemInDropdownListButton() {
        driver.findElement(secondItemInDropdownListButton).click();
    }


    By thirdItemInDropdownListButton = By.xpath("/html/body/div/div/div/div[1]/div[2]/div/span/select/option[3]");
    public void clickOnTheThirdItemInDropdownButton() {
        driver.findElement(thirdItemInDropdownListButton).click();
    }

    By fourthItemInDropdownListButton = By.xpath("/html/body/div/div/div/div[1]/div[2]/div/span/select/option[4]");
    public void clickOnTheFourthItemInDropdownListButton() {
        driver.findElement(fourthItemInDropdownListButton).click();
    }
}